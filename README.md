...
## A quick architecture design
We are looking at building a simple platform where users (the bike sharing companies) can simply supply some data and click on predict to get the best prediction of bike rides in the next 1 month or 1 year as the case may be.
